...
<div class="panel">
        <div class="panel-heading">
          <h3 class="panel-title">Add Slider Images
          ...
          if(isset($_COOKIE['S_ADDED'])){ 
           ...
           ?>
            ...
            <form id="servicesform" action="slider_add.php" method="post" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <!--fetch data dynamically-->
                  ...
                  echo'<div id="'.$row['id'].'">
                    ...
                    <p><b>Name : </b>'.$row['slider_name'].'</p>
                    <p><b>Description : </b>'.$row['slider_description'].'</p>
                    <button type="submit" class="btn btn-primary" id="DS'.$row['id'].'" value="'.$row['id'].'">Delete</button>
                  </div>
                  <hr/>';
                  }
